    ...
    return (
        <Box flex={1} bg={Colors.lightGold} safeAreaTop>
            ...
            <VStack space={6} px={5} alignItems="center" >
                <Buttons bg={Colors.darkestGreen} color={Colors.white} mt={10} bgp={Colors.darkGreen} w="100%">REGISTER</Buttons>
                <Buttons bg={Colors.white} color={Colors.gold} mt={2} bgp={Colors.deepGray} w="100%">LOGIN</Buttons>
            </VStack>
        </Box>
    );
};
